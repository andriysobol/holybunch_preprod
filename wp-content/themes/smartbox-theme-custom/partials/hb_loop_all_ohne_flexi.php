...
<div class="<?php echo oxy_get_option('blog_layout') == TRUE ? 'span12':'span9' ; ?>">
    ...
    <?php 
    $post_type_of_current_post = get_post_type( get_the_ID() );
    if($post_type_of_current_post == 'oxy_content')
        get_template_part( 'partials/content-single-archive', get_post_format() ); 
    elseif($post_type_of_current_post == 'oxy_video')
        get_template_part( 'partials/video-single-archive', get_post_format() ); 
    elseif($post_type_of_current_post == 'oxy_audio')
        get_template_part( 'partials/audio-single-archive', get_post_format() ); 
    ?>
