...
class wf_sn {
  ...
  function min_version_error() {
    echo '<div id="message" class="error"><p>Security Ninja <b>requires WordPress version 3.1</b> or higher to function properly. You\'re using WordPress version ' . get_bloginfo('version') . '. Please <a href="' . admin_url('update-core.php') . '" title="Update WP core">update</a>.</p></div>';
  } // min_version_error
